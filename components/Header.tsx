        ...
        <div className="container mx-auto">
          <nav className="flex justify-between py-4 px-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href="/stories" className="text-white hover:text-primary">
                Stories
              </Link>
              <Link href="/families" className="text-white hover:text-primary">
                Families
              </Link>
              <Link href="/cultures" className="text-white hover:text-primary">
                Cultures
              </Link>
              <Link href="/archive" className="text-white hover:text-primary">
                Archive
              </Link>
